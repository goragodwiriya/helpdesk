...
class Config extends \Kotchasan\Config
{
     ...
     * @var int
     */
    public $helpdesk_w = 500;
    /**
     * ชนิดของไฟล์รูปภาพของ Helpdesk ที่รองรับ
     *
     * @var array
     */
    public $helpdesk_img_typies = ['jpg', 'jpeg', 'png'];
    /**
     * เลขที่ใบแจ้งซ่อม
     *
     * @var string
     */
    public $helpdesk_no = 'TICKET%04d';
    /**
     * เลขที่เอกสาร (Prefix)
     *
     * @var string
     */
    public $helpdesk_prefix = '';
    /**
     * สถานะเปิด Ticket ใหม่
     *
     * @var int
     */
    public $helpdesk_first_status = 1;
    /**
     * สถานะปิด Ticket แล้ว
     *
     * @var int
     */
    public $helpdesk_closed_status = 5;
    /**
     * สถานะเปิด Ticket อีกครั้งหลังจากปิดไปแล้ว
     *
     * @var int
     */
    public $helpdesk_reopened_status = 6;
}
