...
เป็นระบบแจ้งปัญหา และ ติดต่อสอบถามออนไลน์ (Helpdesk หรือ Support) ผ่านบริการบนเว็บไซต์ เขียนด้วยภาษา PHP รองรับการใช้งานบนมือถือ

รายละเอียดเพิ่มเติม https://www.kotchasan.com/index.php?module=knowledge&id=128
...
- เข้าระบบเป็นผู้ดูแลระบบ : `admin@localhost` และ Password : `admin` หรือที่ระบุตอนติดตั้ง
- เข้าระบบเป็นบุคคลทั่วไป : `demo` และ Password : `demo`
- เข้าระบบเป็น Agent : `agent1` และ Password : `agent1`
- เข้าระบบเป็น Agent : `agent2` และ Password : `agent2`
