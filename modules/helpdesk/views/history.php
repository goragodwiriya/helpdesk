<?php
/**
 * @filesource modules/helpdesk/views/history.php
 *
...
class View extends \Helpdesk\Tools\View
{
    ...
    public function render(Request $request, $params)
    {
        ...
        $table = new DataTable(array(
            ...
            'uri' => $uri,
            /* Model */
            'model' => \Helpdesk\History\Model::toDataTable($params),
            /* รายการต่อหน้า */
            'perPage' => $request->cookie('helpdeskHistory_perPage', 30)->toInt(),
            /* เรียงลำดับ */
            'sort' => $request->cookie('helpdeskHistory_sort', 'create_date desc')->toString(),
            /* ฟังก์ชั่นจัดรูปแบบการแสดงผลแถวของตาราง */
            'onRow' => array($this, 'onRow'),
            /* คอลัมน์ที่ไม่ต้องแสดงผล */
            'hideColumns' => array('id', 'customer', 'customer_id', 'priority', 'create_date', 'category', 'latest', 'ticket_no', 'agent_id'),
            /* คอลัมน์ที่สามารถค้นหาได้ */
            'searchColumns' => array('ticket_no', 'subject'),
            /* ตั้งค่าการกระทำของของตัวเลือกต่างๆ ด้านล่างตาราง ซึ่งจะใช้ร่วมกับการขีดถูกเลือกแถว */
            'action' => 'index.php/helpdesk/model/history/action',
        ...
        // save cookie
        setcookie('helpdeskHistory_perPage', $table->perPage, time() + 2592000, '/', HOST, HTTPS, true);
        setcookie('helpdeskHistory_sort', $table->sort, time() + 2592000, '/', HOST, HTTPS, true);
        // คืนค่า HTML
        return $table->render();
    }
    ...
    public function onRow($item, $o, $prop)
    {
        ...
        $subject .= '<span class=icon-clock>'.Date::format($item['create_date'], 'd M Y H:i').'</span>';
